...
export class InitialSchema1767314325278 implements MigrationInterface {
  name = 'InitialSchema1767314325278';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "data_sources" ("id" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "source_type" "public"."data_sources_source_type_enum" NOT NULL DEFAULT 'SQL', "query_sql" text, "api_url" text, "api_method" character varying NOT NULL DEFAULT 'GET', "api_headers" jsonb NOT NULL DEFAULT '{}', "mapping_config" jsonb NOT NULL, "status" "public"."data_sources_status_enum" NOT NULL DEFAULT 'PENDING', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_dc70b1c6b641726739857fd938d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
